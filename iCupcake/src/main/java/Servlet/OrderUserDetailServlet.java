 ...
 * @author Jesper
 */
@WebServlet(name = "OrderUserDetailServlet", urlPatterns = {"/OrderUserDetailServlet"})
public class OrderUserDetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("UserOrderDetails.jsp").forward(request, response);
